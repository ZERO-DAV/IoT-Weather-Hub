...
/* ======================================================================
   ملاحظة: هذا الكود مبني على ESP32 (مو Arduino عادي ولا ESP8266) لأن
   أغلب مشاريعك (زيرو ستوديو وغيره) على ESP32. إذا اللوحة غير كذا خبرني.
   ====================================================================== */
